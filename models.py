...
def get_affiliate(streamer_id):
    """Returns the affiliate document for the given streamer_id, excluding the _id field."""
    return affiliate_collection.find_one({"streamer_id": streamer_id}, {"_id": 0})

def create_affiliate(data):
    """Creates a new affiliate document and sets created_at/updated_at timestamps."""
    try:
...
def update_affiliate(streamer_id, affiliate_url):
    """Updates the affiliate_url for the given streamer_id and updates updated_at."""
